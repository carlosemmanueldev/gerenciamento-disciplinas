...
class ClassroomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create classroom" do
    assert_difference("Classroom.count") do
      post classrooms_url, params: { classroom: { letter: @classroom.letter, school_year: @classroom.school_year, year: @classroom.year } }
    end
  ...
  test "should update classroom" do
    patch classroom_url(@classroom), params: { classroom: { letter: @classroom.letter, school_year: @classroom.school_year, year: @classroom.year } }
